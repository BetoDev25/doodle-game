...
VALUES ($1, $2, $3, $4)
RETURNING id, match_id, user_id, doodle_strokes, finished_strokes, created_at
`
...
SELECT id, match_id, user_id, doodle_strokes, finished_strokes, created_at FROM drawings
WHERE match_id = $1
`
